...
/**
 * Legacy SafeTensorsReader API placeholder.
 * The new IO Core provider (sk.ainet.io.safetensors.SafeTensorsFormatProvider) should be used.
 */
interface SafeTensorsReader {
    fun getTensorNames(): List<String> = emptyList()
    fun readTensor(name: String): Any? = null
    companion object {
        fun fromByteArray(data: ByteArray): SafeTensorsReader = object : SafeTensorsReader {}
        fun fromResource(resourcePath: String): SafeTensorsReader = object : SafeTensorsReader {}
        fun fromFilePath(filePath: String): SafeTensorsReader = object : SafeTensorsReader {}
        fun fromFile(file: Any): SafeTensorsReader = object : SafeTensorsReader {}
    }
}
    /**
